...
if( ! function_exists("rt_slider") ){
	...
	function rt_slider( $atts, $content = null ) {
		...
		$output = '<div id="'.$id.'" class="rt-carousel main-carousel carousel-holder clearfix" data-item-width="1" data-nav="true" data-dots="true" data-parallax="'.$parallax.'" data-timeout="'.$timeout.'" data-autoplay="'.$autoplay.'">'."\n";
