...
get_header(); ?>
	...
	<?php if ( have_posts() ) : ?> 
		...
		<?php while ( have_posts() ) : the_post(); ?>		
			...
			do_action( "rt_content_container", array( "action"=>"start", "sidebar"=>$rt_global_variables['sidebar_position'], "class" => $rt_global_variables["default_content_row_width"], "echo" => $rt_global_variables['sidebar_position'] == "" && $isbuilderactive ? false : true , "overlap" => ! $rt_global_variables["hide_page_title"] || ! $rt_global_variables["hide_breadcrumb_menu"] ) );
			?>
