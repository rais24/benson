...
# 
global $rt_portfolio_post_values;
...
<?php
	if( ! $no_featured_media ){
		...
		do_action( "rt_content_container", array( "action"=>"start", "overlap" => true, "echo" => true, "fullwidth" => $featured_media_width, "class" => $gallery_usage != "gallery" ? "portfolio-media nopadding" : "portfolio-media", "wrapper_class" => "nopadding", "col_class" => $gallery_usage != "gallery" ? "nopadding" : "" ) );
	}
?>
					...
					<?php
						...
						do_action("rt_create_image_carousel",
							array(
								...
								"w"	 => $featured_media_width == "fullwidth" ? 1500 : "",
								"h"	 => $gallery_images_crop ? $gallery_images_max_height : 1500,
