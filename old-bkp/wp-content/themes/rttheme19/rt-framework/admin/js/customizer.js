...
( function( $ ) {
	...
	wp.customize(rt_theme_params["theme_slug"]+'_left_background_color', function( value ) {
  	...
  	wp.customize(rt_theme_params["theme_slug"]+'_nav_item_background_color_active', function( value ) {
		value.bind( function( to ) {   
			...
			$('#navigation > li:hover > a, #navigation > li a:hover, #navigation > li.current-menu-ancestor > a,#navigation > li.current-menu-item > a').css({
				"background-color": to
			});	
		} );
	} );
  	...
  	wp.customize(rt_theme_params["theme_slug"]+'_sub_nav_item_border_color', function( value ) {
		value.bind( function( to ) {   
			...
			$('#navigation > li li > a, #navigation > li ul').css({
				"border-color": to
			});	
		} );
	} );
  	...
  	wp.customize(rt_theme_params["theme_slug"]+'_sub_nav_item_background_color_active', function( value ) {
		value.bind( function( to ) {   
			...
			$('#navigation > li li:hover > a, #navigation > li li a:hover, #navigation > li li.current-menu-ancestor > a,#navigation > li li.current-menu-item > a').css({
				"background-color": to
			});	
		} );
	} );
  	...
  	wp.customize(rt_theme_params["theme_slug"]+'_sub_nav_item_font_color_active', function( value ) {
		value.bind( function( to ) {   
			...
			$('#navigation > li li:hover > a, #navigation > lili a:hover, #navigation > lili.current-menu-ancestor > a,#navigation > li li.current-menu-item > a').css({
				"color": to
			});	
		} );
	} );	
