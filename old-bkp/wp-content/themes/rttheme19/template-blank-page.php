...
<div id="container">
	...
	<?php if ( have_posts() ) : ?> 
		...
		<?php while ( have_posts() ) : the_post(); ?>		
			...
			do_action( "rt_content_container", array( "action"=>"start", "sidebar"=>$rt_global_variables['sidebar_position'], "echo" => $rt_global_variables['sidebar_position'] == "" && $isbuilderactive ? false : true , "overlap" => ! $rt_global_variables["hide_page_title"] || ! $rt_global_variables["hide_breadcrumb_menu"] ) );
			?>
