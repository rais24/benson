	...
	<?php if ( have_posts() ) : ?> 
		...
		<?php while ( have_posts() ) : the_post(); ?>		
			...
			<?php			
				...
				do_action( "rt_content_container", array( "action"=>"start", "echo" => $isbuilderactive ? false : true ) );
			?>
			...
			<?php 
				...
				do_action("rt_content_container",array("action"=>"end", "echo" => $isbuilderactive ? false : true ) );
			?>
