...
/**
 * RT-Theme Color Schemas
 */

$this->color_list[".default-style"] = array( 
	"id" => "default",
	"label" => __("Color Set 1","rt_theme_admin"),
	"description" => '<a class="highlight-section icon-flash" data-section-selector=".default-style" href="#" title="'.__('Blink sections which uses this color set','rt_theme_admin').'"></a>'. __('A color set that can be aplied to any content rows or columns.',"rt_theme_admin"),
	"colors" => array(
...
$this->color_list[".alt-style-1"] = array( 
	"id" => "alt_style_1",
	"label" => __("Color Set 2","rt_theme_admin"),
	"description" => '<a class="highlight-section icon-flash" data-section-selector=".alt-style-1" href="#" title="'.__('Blink sections which uses this color set','rt_theme_admin').'"></a>'. __('A color set that can be aplied to any content rows or columns.',"rt_theme_admin"),
	"colors" => array(
...
$this->color_list[".alt-style-2"] = array( 
	"id" => "alt_style_2",
	"label" => __("Color Set 3","rt_theme_admin"),
	"description" => '<a class="highlight-section icon-flash" data-section-selector=".alt-style-2" href="#" title="'.__('Blink sections which uses this color set','rt_theme_admin').'"></a>'. __('A color set that can be aplied to any content rows or columns.',"rt_theme_admin"),
	"colors" => array(
		...
		"heading_color"         => array("color"=> "#fff", "label" => __("Heading Colorlor","rt_theme_admin")),
...
$this->color_list[".light-style"] = array( 
	"id" => "light_style",
	"label" => __("Color Set 4","rt_theme_admin"),
	"description" => '<a class="highlight-section icon-flash" data-section-selector=".light-style" href="#" title="'.__('Blink sections which uses this color set','rt_theme_admin').'"></a>'. __('A color set that can be aplied to any content rows or columns.',"rt_theme_admin"),
	"colors" => array(
...
$this->color_list[".sidebar-widgets"] = array( 
	"id" => "widgets",
...
$this->color_list[".footer"] = array( 
	...
	"colors" => array(
		...
		"light_text_color"      => array("color"=> "#ffffff", "label" => __("Light Text Color","rt_theme_admin")),
...
$this->options["rt_color_schemas"] = array(
		...
		'sections' => array(
							...
							array(
								...
								'title'    => __("Pre-Made Skins", "rt_theme_admin"), 
								'controls' => array( 

													array(
														'id'        => 'rt_skin_selector_html',
														'label'     => __("Skin Selector",'rt_theme_admin'),
														'type'      => 'rt_content', 
														"transport" => "postMessage",
														'description' => '<p>'.__("Select a pre-made skin to use. Once you select a skin from the list, it's settings will be applied to the live preview only and won't affect your website unliness you save & publish the changes.",'rt_theme_admin').'</p><span id="rt-skin-selector" class="button-secondary rt-skin-selector" tabindex="0">'.__('Select a Skin','rt_theme_admin').'</span>',
													), 
							...
							array(
								...
								"description" => '<a class="highlight-section icon-flash" data-section-selector="body" href="#" title="'.__('Blink the body in the current page','rt_theme_admin').'"></a>'. __('Following settings will be applied to the page body. Remember if your have solid backgroud color or image set for left and right sides, the body will be covered by them.',"rt_theme_admin"),
								'controls' => array( 
							...
							array(
								...
								'controls' => array( 
													...
													array(
														...
														"label"       => "",
														"description" => __('Header Bar Styling','rt_theme_admin'),															
														"type"        => "rt_seperator"
													),
							...
							array(
								...
								"description" => '<a class="highlight-section icon-flash" data-section-selector="#navigation,.header-right nav" href="#" title="'.__('Blink the main mavigation are in the current page. ','rt_theme_admin').'"></a>'. __('Use following settings to customize your main navigation',"rt_theme_admin"),
								'controls' => array( 
...
foreach ($this->color_list as $seletor => $schema ) {
	...
	array_push($this->options["rt_color_schemas"]["sections"], array(
			'id'          => $schema["id"],
			'title'       => $schema["label"], 
...
/**
 * Add additional controls to the sidebar colors
 */

array_unshift($this->options["rt_color_schemas"]["sections"][15]["controls"],
 ...
 */
array_unshift($this->options["rt_color_schemas"]["sections"][16]["controls"],


				array(
					"id"          => RT_THEMESLUG."_footer_widget_layout",															
					"label"       => __("Footer Widgets Layout",'rt_theme_admin'),
					"description" => __("Select and set the column layout of the footer widget area. Footer widgets can be presented into 1 column up to 4 columns.",'rt_theme_admin'),
					"choices"     =>  array(
										"1/4" => "1/4",
										"1/3" => "1/3",
										"1/2" => "1/2",
				...
				array(
					...
					"label"       => __("Footer Background Width",'rt_theme_admin'),
					"description" => __('Select a pre-defined width for the footer background','rt_theme_admin'),
					"transport"   => "refresh",															
					"choices"     => array(		
				...
				array(
					...
					"label"       => __("Footer Content Width",'rt_theme_admin'),
					"description" => __('Select a pre-defined width for the footer content','rt_theme_admin'),
					"transport"   => "refresh",															
					"choices"     => array(		
										"default" => __("Default Width", "rt_theme_admin"),
										"fullwidth" => __("Full Width", "rt_theme_admin"),
