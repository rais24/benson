...
<div class="space10"></div>
	...
	$options[] = array(
	 ...
	 $options[] = array(
		'desc' => '<a href="'.esc_url(SKT_URL).'" target="_blank"><img src="'.get_template_directory_uri().'/images/sktskill.jpg"></a><p><em><a target="_blank" href="'.esc_url(SKT_THEME_URL_DIRECT).'">'.__('Buy PRO version for only $30 with more features.','the-app').'</a></em></p>',
		'type' => 'info');	
